    ...
    <section id="candidates" class="content-header">
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked" >
                    ...
                    <li class="active"  style="font-size: 18px;"><a href="my-job-post.php"><i class="fa fa-file-o"></i> My Job Post</a></li>
          ...
          <h3 style="font-size: 42px; font-weight:bold">MY <span style="color: #7D0A0A; font-size: 38px">JOB POST </span></h3>
