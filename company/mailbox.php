        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">            
              <h3 class="box-title" style="margin-bottom: 20px; font-size:34px; font-weight:bold;color: #7D0A0A;">MAILBOX</h3>
              <div class="pull-right">
                <a href="create-mail.php" class="btn btn-flat" style="background-color:#5F8670; color:white"><i class="fa fa-envelope"></i> Create</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
