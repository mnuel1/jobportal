      ...
      <div class="container">
        <div class="row">
              ...
              <div style="padding:10px; display:flex; justify-content:center;">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked" >
                    ...
                    <li class="active" style="font-size: 18px;"><a href="resume-database.php"><i class="fa fa-user"></i> Resume Database</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h3 style="font-size: 42px; font-weight:bold"><span style="color: #7D0A0A; font-size: 38px">TALENT </span> DATABASE </h3>
