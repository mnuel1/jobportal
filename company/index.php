      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked" >
                  <li class="active" style="font-size: 18px;"><a href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                  <li style="font-size: 18px;"><a href="edit-company.php"><i class="fa fa-tv"></i> My Company</a></li>
                  <li style="font-size: 18px;"><a href="create-job-post.php"><i class="fa fa-file-o"></i> Create Job Post</a></li>
                  <li style="font-size: 18px;"><a href="my-job-post.php"><i class="fa fa-file-o"></i> My Job Post</a></li>
                  <li style="font-size: 18px;"><a href="job-applications.php"><i class="fa fa-file-o"></i> Job Application</a></li>
                  <li style="font-size: 18px;"><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li>
                  <li style="font-size: 18px;"><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
                  <li style="font-size: 18px;"><a href="resume-database.php"><i class="fa fa-user"></i> Resume Database</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3 style="font-size: 42px; font-weight:bold; color: #7D0A0A;">OVERVIEW</h3>
            <div class="alert alert-dismissible" style="background-color: #0a2e7d; color:white">
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text" style="font-weight:500">Job Posted</span>
                    <?php
                    ...
                    ?>
                    <span class="info-box-number" style="font-size:32px"><?php echo $total; ?></span>
                  </div>
                </div>                
              </div>
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text" style="font-weight:500">Application For Jobs</span>
                    <?php
