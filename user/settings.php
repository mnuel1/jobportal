      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li style="font-size: 18px;"  class="active"><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h3 style="font-size: 42px; font-weight:bold">CHANGE <span style="color: #7D0A0A; font-size: 38px">PASSWORD </span></h3>
