...
$total_query = "SELECT COUNT(*) as total FROM apply_job_post
...
LEFT JOIN company ON company.id_company  = company.id_company 
WHERE CONCAT(users.firstname, ' ', users.lastname) LIKE '%$search%' OR company.companyname LIKE '%$search%'";
$total_result = $conn->query($total_query);
$total_rows = $total_result->fetch_assoc()['total'];

// Query to get paginated and filtered results
$sql = "SELECT apply_job_post.*, CONCAT(users.firstname, ' ', users.lastname) as fullname, users.resume as resumePath,
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo ' <span class="label">'.$status.'</span>';?></td>
                                <td><?php echo $row['companyname']; ?></td>                               
                                <?php if($row['resumePath'] != '') { ?>
                                    <td style="display:flex; justify-content:center"><a href="/uploads/resume/<?php echo $row['resumePath']; ?>" 
