...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php" style="color: #7D0A0A; font-size:55px"><b>Job</b> Search</a>
  </div>
  <!-- /.login-logo -->
    ...
    <form method="post" action="checkcompanylogin.php">
      ...
      <div class="form-group has-feedback">
        ...
        <label style="margin-top: 10px; display:flex; align-items:center; gap:5px;">
            <button type="button" onclick="togglePassword()" class="">
              <i id="password-icon" class="fa fa-eye"></i> Show Password
            </button>
        </label>   
      </div>
      <div class="row">
