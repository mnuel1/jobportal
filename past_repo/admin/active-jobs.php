      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li style="font-size: 18px;" class="active"><a href="active-jobs.php"><i class="fa fa-briefcase"></i> Active Jobs</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3 style="font-size: 42px; font-weight:bold">ACTIVE JOB 
            <span style="color: #7D0A0A; font-size: 38px">POSTS</span></h3>
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="margin:auto"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o"></i></a></td>
                        <td style="display:flex; justify-content:center">
                          <a href="delete-job-post.php?id=<?php echo $row['id_jobpost']; ?>">
                            <i class="fa fa-trash" style="color: #7D0A0A;"></i></a></td>
                      </tr>  
                            <?php
                        }
                      }
