    ...
    <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20">
          <h1 class="text-center margin-bottom-20" style="font-weight:bold; font-size:5vw;">SIGN UP</h1>
		  <br>
          <div class="col-md-6 latest-job ">
            <div class="small-box padding-5" style="background-color:#5F8670;cursor:pointer">
              <div class="inner">
          ...
          <div class="col-md-6 latest-job ">
            <div class="small-box padding-5" style="background-color:#FF9800;cursor:pointer"">
              <div class="inner">
