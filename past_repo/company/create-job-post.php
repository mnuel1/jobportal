      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked" >
                    ...
                    <li class="active" style="font-size: 18px;"><a href="create-job-post.php"><i class="fa fa-file-o"></i> Create Job Post</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3 style="font-size: 42px; font-weight:bold">CREATE <span style="color: #7D0A0A; font-size: 38px">JOB POST </span></h3>
            <div class="row">
