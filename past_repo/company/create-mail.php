        ...
        <div class="row">
            ...
            <div style="padding:10px; display:flex; justify-content:center;">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked" >
                  ...
                  <li class="active" style="font-size: 18px;"><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li>
          ...
          <form action="add-mail.php" method="post">
            <div class="box box-primary">
              ...
              <h3 class="box-title" style="margin-bottom: 20px; font-size:34px; font-weight:bold;">COMPOSE 
                <span style="color: #7D0A0A; font-size:32px">NEW MESSAGE</span></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
              ...
              <div class="box-footer">
                <div class="pull-right">
                  ...
                  style="background-color:green; color:white"><i class="fa fa-envelope-o"></i> Send</button>
                </div>
