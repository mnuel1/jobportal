    ...
    <section id="candidates" class="content-header">
      <div class="container">
        <div class="row">
              ...
              <div style="padding:10px; display:flex; justify-content:center;">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked" >
                    ...
                    <li class="active" style="font-size: 18px;"><a href="job-applications.php"><i class="fa fa-file-o"></i> Job Application</a></li>
          ...
          <h3 style="font-size: 42px; font-weight:bold">RECENT <span style="color: #7D0A0A; font-size: 38px">APPLICATIONS </span></h3>            
