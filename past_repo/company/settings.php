      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked" >
                    <li style="font-size: 18px;"><a href="index.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                    ...
                    <li class="active" style="font-size: 18px;"><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h3 style="font-size: 42px; font-weight:bold">ACCOUNT <span style="color: #7D0A0A; font-size: 38px">SETTINGS </span></h3>            
                ...
                <div class="row">
                  <div class="col-md-6">
                    <form action="deactivate-account.php" method="post">
                      ...
                      <input type="checkbox" required > I Want To Deactivate My Account</label>
