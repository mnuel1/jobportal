    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          <li>
            <a href="../jobs.php" style="margin-right: 7rem; font-size:18px;border:1px solid white">Jobs</a>
          </li>          
        </ul>
      </div>
    </nav>
      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  <li style="font-size: 18px;" class="active"><a href="edit-profile.php"><i class="fa fa-user"></i> Edit Profile</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h3 style="font-size: 42px; font-weight:bold">EDIT <span style="color: #7D0A0A; font-size: 38px">PROFILE </span></h3>
              ...
              <div class="row">
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="state" name="state"  placeholder="state" onkeypress="return validateName(event);" value="<?php echo $row['state']; ?>">
                  </div>
                  <div class="form-group">
