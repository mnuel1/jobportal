    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php } ?>
          <li>
            <a href="logout.php" style="border: 1px solid white; margin-right: 12rem; font-weight: bold;">Logout</a>
          </li>
          <?php } ?>          
        </ul>
      </div>
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          ...
          <h1 class="text-center" style="font-weight:600">LATEST 
          <span style="color: #7D0A0A; font-size:55px">OFFERS</span></h1>           
            <div class="input-group input-group-lg">
                <input type="text" id="searchBar" class="form-control" placeholder="Search job">
                <span class="input-group-btn">
                  <button id="searchBtn" type="button" class="btn btn-info btn-flat"> <i class="fa fa-search" aria-hidden="true"></i> 
                  Search</button>
                </span>
            </div>
          </div>
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Bengaluru"><i class="fa fa-circle-o text-yellow"></i> Makati</a></li>
                      <li><a href="" class="citySearch" data-target="Navi Mumbai"><i class="fa fa-circle-o text-yellow"></i> Pateros</a></li>
                      <li><a href="" class="citySearch" data-target="Navi Mumbai"><i class="fa fa-circle-o text-yellow"></i> Pasig</a></li>
                      <li><a href="" class="citySearch" data-target="Navi Mumbai"><i class="fa fa-circle-o text-yellow"></i> BGC</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
